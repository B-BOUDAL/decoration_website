    ...
    <div class="grid grid-cols-1 lg:grid-cols-1 p-4 gap-4">
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md text-5xl font-extrabold">
                ...
                <form action="/admin/annonce/update" method="post" class="space-y-8" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        ...
                        <img src="{{asset('storage/annonce').'/'. $annonce->image }}" width="100px" alt="">
                    </div>
                    <div>
                        <label for="prix" class="block mb-2 text-sm font-serif text-amber-900 dark:text-gray-300">date_debut</label>
                        <input type="date" id="prix" value="{{ $annonce->date_debut }}" name="prix" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required>
                    </div>
                    <div>
                        <label for="prix" class="block mb-2 text-sm font-serif text-amber-900 dark:text-gray-300">date_fin</label>
                        <input type="date" id="prix" value="{{ $annonce->date_fin }}" name="prix" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required>
                    </div>
                    <div>
                       
                    </div>
                    
                    <button type="submit" class="py-3 px-5 text-sm font-serif text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Edit</button>
                </form>
            </div>
          </section>
    </div>
